                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <form class="form-horizontal" action="<?php echo base_url()?>dashboard/update_event/<?php echo $row->id ?>" method="post" enctype="multipart/form-data">
                                                <div class="card-body">
                                                    <div class="form-group row">
                                                        <label for="title" class="col-sm-2 text-right control-label col-form-label">Title</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="title" id="title" placeholder="<?php echo $row->title; ?>" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <textarea class="form-control" id="detail" name="detail" rows="5" placeholder="<?php echo $row->detail; ?>" required></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select id="tag" name="tag" class="select2 form-control custom-select" style="width: 100%; height:36px;" required>
                                                                <option value="<?php echo $row->tag; ?>" selected><?php echo $row->tag;?></option>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10 input-group">
                                                            <input type="text" name="date" class="form-control" id="datepicker-autoclose" placeholder="<?php echo $row->date?>" required>
