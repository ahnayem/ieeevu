                                            ...
                                            <table class="table table-bordered" id="event-table" width="100%" cellspacing="0">
                                                ...
                                                <tbody align="center">
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td><a href="<?php echo base_url()?>resources/assets1/img/image/<?php echo $row->image?>" target="_blank">click to view</a></td>

                                                    <td><center>

                                                    <a onclick="return ConfirmDelete();" href="<?php echo base_url()?>dashboard/image_delete/<?php echo $row->id?>" class="btn btn-warning"><i class="fa fa-trash-alt" ></i></a></center></td>
                                                </tr>
                                                  <?php endforeach; ?>
                                                </tbody>            
                                            </table>
