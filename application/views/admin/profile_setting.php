                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div>
                                            ...
                                            <h5 class="card-subtitle">Please fill all the field carefully*</h5><br><br>
                                        </div>
                                    </div>
                                        <div class="card">
                                            <form class="form-horizontal" action="<?php echo base_url()?>dashboard/password_update" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-3">
                                            <div class="col-md-10">
                                                <form class="form-horizontal" action="<?php echo base_url()?>dashboard/update_profile_photo" method="post" enctype="multipart/form-data">
                                                    <div class="form-group row">
                                                        <img src="<?php echo base_url()?>resources/assets1/img/users/<?php echo $this->session->userdata('user_image') ?>" alt="user"  width="100%" height="200">
                                                    </div>
