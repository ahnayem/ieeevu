                                            ...
                                            <form class="form-horizontal" action="<?php echo base_url()?>dashboard/update_event/<?php echo $row->id ?>" method="post" enctype="multipart/form-data">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <textarea class="form-control" id="detail" name="detail" rows="5"required><?php echo $row->detail; ?></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="image" class="col-md-2 text-right control-label">Image</label>
                                                ...
                                                <div class="border-top">
                                                    <div class="card-body">
                                                        ...
                                                        <a class="btn btn-secondary" href="<?php echo base_url()?>dashboard/events">Back</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
