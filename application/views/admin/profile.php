                                    ...
                                    <div class="col-md-6" style="padding: 20px">
                                        <div class="d-md-flex align-items-center">
                                            <div>
                                                ...
                                                <h5 class="card-subtitle">Information given by admin</h5><br><br>
                                            </div>
                                        </div>
                                        <h3><span style="color: #f0954e;">Name: </span><?php echo $this->session->userdata('user_name') ?></h3>
                                        <h3><span style="color: #f0954e;">Email: </span><?php echo $this->session->userdata('user_email') ?></h3>
                                        <h3><span style="color: #f0954e;">From: </span><?php echo $this->session->userdata('user_date') ?></h3>
                                    </div>
                                    <div class="col-md-6">
                                         <img src="<?php echo base_url()?>resources/assets1/img/users/<?php echo $this->session->userdata('user_image') ?>" alt="user"  width="300" height="300">
                                    </div>
                                    <!-- column -->
                                </div>
                            </div>
